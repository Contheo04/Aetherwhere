...
public class MainWindow : Window, IDisposable
{
    ...
    private readonly List<AetherCurrentData> aetherCurrents = new()
    {
        ...
        new("Heavensward", "Coerthas Western Highlands", 32.4f, 35.8f, "Quest", "Bridge Over Frozen Water"), // "Bridge Over Frozen Water" quest
        new("Heavensward", "Coerthas Western Highlands", 16.9f, 22.8f, "Quest", "For All the Nights to Come"), // "For All the Nights to Come" quest
        new("Heavensward", "Coerthas Western Highlands", 16.7f, 22.8f, "Quest", "Baby Steps"), // "Baby Steps" quest
        new("Heavensward", "Coerthas Western Highlands", 16.5f, 22.5f, "Quest", "Protecting What's Important"), // "Protecting What's Important" quest
        new("Heavensward", "Coerthas Western Highlands", 16.4f, 22.4f, "Quest", "Purple Flame, Purple Flame"), // "Purple Flame, Purple Flame" quest
        ...
        new("Heavensward", "The Dravanian Forelands", 31.9f, 23.9f, "Quest", ""), // "Some Bad News"
        new("Heavensward", "The Dravanian Forelands", 24.9f, 19.7f, "Quest", ""), // "Stolen Munitions"
        new("Heavensward", "The Dravanian Forelands", 16.4f, 23.0f, "Quest", ""), // "A Lesson in Humility"
        new("Heavensward", "The Dravanian Forelands", 23.0f, 19.0f, "Quest", ""), // "Mourn in Passing"
        new("Heavensward", "The Dravanian Forelands", 31.9f, 23.9f, "Quest", ""),  // "The Hunter Becomes the Kweh"
        ...
        new("Heavensward", "The Dravanian Hinterlands", 21.0f, 18.0f, "Quest", ""), // "Louder than Words"
        new("Heavensward", "The Dravanian Hinterlands", 7.0f, 6.0f, "Quest", ""),   // "Ebb and Aetherflow"
        new("Heavensward", "The Dravanian Hinterlands", 5.0f, 6.0f, "Quest", ""),   // "Taking Stock"
        new("Heavensward", "The Dravanian Hinterlands", 21.0f, 15.0f, "Quest", ""), // "Systematic Exploration"
        new("Heavensward", "The Dravanian Hinterlands", 6.0f, 10.0f, "Quest", ""),   // "In Node We Trust"
        ...
        new("Heavensward", "The Churning Mists", 33.0f, 15.0f, "Quest", ""), // "Waiting to Inhale"
        new("Heavensward", "The Churning Mists", 27.5f, 33.8f, "Quest", ""), // "Road Kill"
        new("Heavensward", "The Churning Mists", 12.3f, 29.5f, "Quest", ""), // "Hide Your Moogles"
        new("Heavensward", "The Churning Mists", 13.3f, 11.0f, "Quest", ""), // "Into the Aery"
        ...
        new("Heavensward", "The Sea of Clouds", 17.0f, 37.0f, "Quest", ""), // "Clipped Wings"
        new("Heavensward", "The Sea of Clouds", 11.5f, 10.9f, "Quest", ""), // "Honoring the Past"
        new("Heavensward", "The Sea of Clouds", 9.6f, 14.2f, "Quest", ""), // "Sleepless in Ok' Zundu"
        new("Heavensward", "The Sea of Clouds", 10.6f, 14.8f, "Quest", ""), // "Flying the Nest"
        new("Heavensward", "The Sea of Clouds", 10.8f, 13.6f, "Quest", ""), // "Bolt, Chain, and Island"

        new("Heavensward", "Azys Lla", 21.0f, 18.0f, "Quest", ""), // "Systematic Exploration"
        new("Heavensward", "Azys Lla", 7.0f, 6.0f, "Quest", ""),   // "In Node We Trust"
        new("Heavensward", "Azys Lla", 5.0f, 6.0f, "Quest", ""),   // "Chimerical Maintenance"
        new("Heavensward", "Azys Lla", 21.0f, 15.0f, "Quest", ""), // "Close Encounters of the VIth Kind"
        new("Heavensward", "Azys Lla", 6.0f, 10.0f, "Quest", ""),   // "Fetters of Lament"
        ...
        new("Stormblood", "The Peaks", 24.3f, 6.8f, "Quest", ""),  // "Saint Sayer"
        new("Stormblood", "The Peaks", 27.7f, 28.7f, "Quest", ""), // "A Hunger for Trade"
        new("Stormblood", "The Peaks", 14.9f, 36.6f, "Quest", ""), // "Out of Sight"
        new("Stormblood", "The Peaks", 27.1f, 36.5f, "Quest", ""), // "Closing Up Shop"
        new("Stormblood", "The Peaks", 26.7f, 36.2f, "Quest", ""), // "Liberty or Death"
        ...
        new("Stormblood", "Yanxia", 30.4f, 17.6f, "Quest", ""), // "Fly My Pretties"
        new("Stormblood", "Yanxia", 20.7f, 15.6f, "Quest", ""), // "Something Smells"
        new("Stormblood", "Yanxia", 30.1f, 18.9f, "Quest", ""), // "Wolves and Weeds"
        new("Stormblood", "Yanxia", 30.7f, 18.0f, "Quest", ""), // "Whacking Day"
        new("Stormblood", "Yanxia", 31.2f, 28.9f, "Quest", ""), // "All the Little Angels"
        ...
        new("Stormblood", "The Lochs", 32.6f, 23.4f, "Quest", ""), // "The Lies We Tell"
        new("Stormblood", "The Lochs", 21.2f, 36.2f, "Quest", ""), // "A Rite to Rest"
        new("Stormblood", "The Lochs", 27.5f, 16.8f, "Quest", ""), // "The Reluctant Researcher"
        new("Stormblood", "The Lochs", 35.0f, 21.0f, "Quest", ""), // "The Price of Freedom"
        new("Stormblood", "The Lochs", 19.0f, 31.0f, "Quest", ""),  // "The Will to Live"
        ...
        new("Stormblood", "The Azim Steppe", 32.9f, 28.3f, "Quest", ""), // "Words Are Very Unnecessary"
        new("Stormblood", "The Azim Steppe", 28.1f, 15.1f, "Quest", ""), // "Sheep Snatcher"
        new("Stormblood", "The Azim Steppe", 23.0f, 23.3f, "Quest", ""), // "Forty Years and Counting"
        new("Stormblood", "The Azim Steppe", 12.7f, 34.4f, "Quest", ""), // "Mauci of the Seven Worries"
        new("Stormblood", "The Azim Steppe", 16.8f, 22.9f, "Quest", ""), // "The Children of Azim"
        ...
        new("Shadowbringers", "Lakeland", 7.4f, 14.4f, "Quest", ""),  // "An Unreasonable Request"
    ...
    public override void Draw()
    {
        ...
        if (table.Success)
        {
            ...
            foreach (var current in aetherCurrents.Where(a =>
                a.Expansion == selectedExpansionName && a.Zone == areas[SelectedArea]))
            {
                ...
                {
                    ImGui.TextUnformatted(current.IsCollected ? FontAwesomeIcon.Check.ToIconString() : FontAwesomeIcon.Times.ToIconString());
                }
                ...
                ImGui.TableNextColumn();
                ImGui.SetCursorPosY(ImGui.GetCursorPosY() + (rowHeight * 0.25f));
                ImGui.TextUnformatted(current.Description);
